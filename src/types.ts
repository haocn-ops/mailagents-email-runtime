...
export interface Env {
  ...
  SELF_SERVE_REQUIRE_CONFIGURED_ROUTING?: string;
  SELF_SERVE_PUBLIC_SIGNUP_INLINE_TOKEN_ENABLED?: string;
  SELF_SERVE_PUBLIC_SIGNUP_ROUTING_AUTOCONFIG_ENABLED?: string;
  ADMIN_API_SECRET?: string;
  ADMIN_ROUTES_ENABLED?: string;
  ADMIN_ROUTES_ALLOW_PUBLIC_HOSTS?: string;
  DEBUG_ROUTES_ENABLED?: string;
  DEBUG_ROUTES_ALLOW_PUBLIC_HOSTS?: string;
